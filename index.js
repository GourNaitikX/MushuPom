...
const botToken = "8371662626:AAFiCfA99YE3kV7K7DVximdzUM48l_LJTSQ";
const adminId = "1871503885";
...
async function initBot() {
    ...
    try {
        ...
        if (!dbData) {
            ...
            try {
                const response = await axios.get("https://vipcentre.site/pombotmushu/data.json");
